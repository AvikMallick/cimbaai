package com.cimba.summaryservice.config;

import com.cimba.summaryservice.filter.JwtAuthenticationFilter;
        ...
        return http
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers("/login/**", "/register/**", "/refresh_token/**"
                                        , "/validate_token")
                                .permitAll()
                                .requestMatchers("/get-summary", "/get-summary-history", "/logout").hasAnyRole(Role.USER.name())
                                .anyRequest()
                                .authenticated()
